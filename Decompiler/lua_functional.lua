...
-- EDITS:
- Improved lfunc.apply speed.
- map v's also have to take tables.
...
-- +14+15. Kapeesh?
lfunc.curry = function(f,_n)
	local n = _n or debug.getinfo(f, "u").nparams --9/16/2014: added use of debug.getinfo to get number of parameters.
    return function(...)
